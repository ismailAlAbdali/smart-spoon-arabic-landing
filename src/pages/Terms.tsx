        ...
        <div className="max-w-3xl mx-auto space-y-6 text-right">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <ul className="space-y-3">
              ...
              <li>• الي يريد اشتراك ويكند يقوم بإبلاغنا مسبقاً</li>
            </ul>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <ul className="space-y-3">
              <li>
                • اشتراكات حروب اسبوع او اسبوعين او اسبوعين تختلف حسب طريقة
                التقسيط
              </li>
              <li>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <ul className="space-y-3">
              ...
              <li>
                • الجدول الاسبوعي للوجبات كالتالي: وجبتين دجاج بشكلين مختلفة
